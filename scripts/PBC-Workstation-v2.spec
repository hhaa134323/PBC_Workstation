...
a = Analysis(
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=['pytest', 'pytest_asyncio', 'IPython', 'jupyter', 'notebook', 'matplotlib', 'numpy', 'scipy', 'sklearn', 'tensorflow', 'torch'],
    noarchive=False,
    optimize=0,
)
pyz = PYZ(a.pure)
